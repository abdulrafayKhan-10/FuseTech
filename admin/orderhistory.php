                ...
                <div class="container-fluid px-4">
                            ...
                            <table class="table table-bordered text-center" id="datatablesSimple">
                                ...
                                <?php 
                                  ...
                                  $select_query_delivered = "SELECT * FROM tbl_order INNER JOIN tbl_user ON tbl_user.id = tbl_order.u_id WHERE `status` = '1'";
                                ...
                                <tr>
                                    ...
                                    <td><a href="vieworder.php?id=<?php echo $purchase_delivered['o_id']; ?>"
